...
void main() {
  ...
  testWidgets('loads and renders the reference assembled lesson', (
    ...
    await _pumpUntilFound(tester, find.text('Завершити перший контакт'));
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(find.text('Read Hola'), findsNothing);
    },
  );
...
Widget _app(
  ...
  return ProviderScope(
    overrides: [
      ...
      if (supportLocale == null) _emptySemanticLocalizationOverride,
